...
| Windows (x64) | [openmmo-agent-v0.57.0-p96-windows-x64.exe](https://github.com/OpenMMO-Agent-UI/openmmo-agent-wiki/releases/latest/download/openmmo-agent-v0.57.0-p96-windows-x64.exe) |
| Linux (x64) | [openmmo-agent-v0.57.0-p96-linux-x64.AppImage](https://github.com/OpenMMO-Agent-UI/openmmo-agent-wiki/releases/latest/download/openmmo-agent-v0.57.0-p96-linux-x64.AppImage) |
