...
| Windows (x64) | [openmmo-agent-v0.48.0-p68-windows-x64.exe](https://github.com/OpenMMO-Agent-UI/openmmo-agent-wiki/releases/latest/download/openmmo-agent-v0.48.0-p68-windows-x64.exe) |
| Linux (x64) | [openmmo-agent-v0.48.0-p68-linux-x64.AppImage](https://github.com/OpenMMO-Agent-UI/openmmo-agent-wiki/releases/latest/download/openmmo-agent-v0.48.0-p68-linux-x64.AppImage) |
