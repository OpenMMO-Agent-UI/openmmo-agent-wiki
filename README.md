...
| Windows (x64) | [openmmo-agent-v0.52.2-p80-windows-x64.exe](https://github.com/OpenMMO-Agent-UI/openmmo-agent-wiki/releases/latest/download/openmmo-agent-v0.52.2-p80-windows-x64.exe) |
| Linux (x64) | [openmmo-agent-v0.52.2-p80-linux-x64.AppImage](https://github.com/OpenMMO-Agent-UI/openmmo-agent-wiki/releases/latest/download/openmmo-agent-v0.52.2-p80-linux-x64.AppImage) |
