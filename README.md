...
| 平台 | 下載 |
|---|---|
| macOS (Apple Silicon) | [openmmo-agent-v0.34.0-p37-macos-arm64.zip](https://github.com/OpenMMO-Agent-UI/openmmo-agent-wiki/releases/latest/download/openmmo-agent-v0.34.0-p37-macos-arm64.zip) |
| Windows (x64) | [openmmo-agent-v0.34.0-p37-windows-x64.exe](https://github.com/OpenMMO-Agent-UI/openmmo-agent-wiki/releases/latest/download/openmmo-agent-v0.34.0-p37-windows-x64.exe) |
| Linux (x64) | [openmmo-agent-v0.34.0-p37-linux-x64.AppImage](https://github.com/OpenMMO-Agent-UI/openmmo-agent-wiki/releases/latest/download/openmmo-agent-v0.34.0-p37-linux-x64.AppImage) |
