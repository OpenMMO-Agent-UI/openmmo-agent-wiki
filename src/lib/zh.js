...
export const itemNames = {
  ...
  great_sword: '巨劍',
  furniture_bed: '床',
  furniture_signpost: '路標',
  furniture_signpost_mirrored: '路標(鏡像)',
  furniture_shop_sign: '商店招牌',
  furniture_shop_sign_plank: '商店招牌(木板)',
  furniture_shop_sign_oval: '商店招牌(深色橢圓)',
  furniture_barrel: '木桶',
  furniture_crate: '木箱',
  furniture_chest: '箱子',
  furniture_chair: '椅子',
  furniture_table: '桌子',
  furniture_rustic_bed: '樸素木床',
  furniture_stone_hearth: '石造壁爐',
  furniture_torch_wall: '壁掛火把',
  furniture_health_potion: '高級治療藥水裝飾品',
  furniture_healing_potion: '治療藥水裝飾品',
  furniture_scroll: '捲軸裝飾品',
  furniture_scroll_enchant: '武器強化捲軸裝飾品',
  furniture_scroll_enchant_armor: '防具強化捲軸裝飾品',
  furniture_iron_sword: '鐵劍裝飾品',
...
export const itemDescriptions = {
  ...
  scroll_of_teleportation: '誦讀符文後,會被傳送到最遠 2 公里內的隨機地點,可能落在戶外,也可能落在地城的任一樓層。',
  ...
  chicken_rice: '陽光燉雞蓋飯,配著紅蘿蔔與花椰菜。客棧餐桌限定供應。',
  chicken_curry: '雞肉咖哩蓋飯,配著紅蘿蔔與蔬菜。客棧餐桌限定供應。',
  fried_rice: '滿滿一盤炒飯,拌著雞肉與蔬菜。客棧餐桌限定供應。',
  vegetable_rice: '白飯配著清蒸紅蘿蔔與花椰菜。客棧餐桌限定供應。',
  beer: '客棧酒桶倒出的木製大酒杯泡沫麥酒。客棧餐桌限定供應。',
  wine: '青銅高腳杯裝著的深紅色紅酒。客棧餐桌限定供應。',
  ...
  stethoscope: '黃銅聽診器,附皮管與喇叭形耳塞。裝備在頸部即可使用「聽診」技能,檢視目標的生命值、Guard 與裝備強化。',
  horse_reins: '使用可以騎乘或下馬。在戶外騎乘的移動速度是步行的兩倍。可重複使用,進入戰鬥或室內會自動下馬。',
  rowboat: '在水面使用可以上船或下船。水深只要夠釣魚就能划,速度比涉水快。可重複使用,划進淺水會自動擱淺下船。',
  ...
  furniture_bed: '拆封後可在自己的領地放置床。ORKEA 出品的裝飾家具。',
  furniture_signpost: '拆封後可在自己的領地放置路標。ORKEA 出品的裝飾家具。',
  furniture_signpost_mirrored: '拆封後可在自己的領地放置路標(鏡像)。ORKEA 出品的裝飾家具。',
  furniture_shop_sign: '拆封後可在自己的領地放置商店招牌。ORKEA 出品的裝飾家具。',
  furniture_shop_sign_plank: '拆封後可在自己的領地放置商店招牌(木板)。ORKEA 出品的裝飾家具。',
  furniture_shop_sign_oval: '拆封後可在自己的領地放置商店招牌(深色橢圓)。ORKEA 出品的裝飾家具。',
  furniture_barrel: '拆封後可在自己的領地放置木桶。ORKEA 出品的裝飾家具。',
  furniture_crate: '拆封後可在自己的領地放置木箱。ORKEA 出品的裝飾家具。',
  furniture_chest: '拆封後可在自己的領地放置箱子。ORKEA 出品的裝飾家具。',
  furniture_chair: '拆封後可在自己的領地放置椅子。ORKEA 出品的裝飾家具。',
  furniture_table: '拆封後可在自己的領地放置桌子。ORKEA 出品的裝飾家具。',
  furniture_rustic_bed: '拆封後可在自己的領地放置樸素木床。ORKEA 出品的裝飾家具。',
  furniture_stone_hearth: '拆封後可在自己的領地放置石造壁爐。ORKEA 出品的裝飾家具。',
  furniture_torch_wall: '拆封後可在自己的領地放置壁掛火把。ORKEA 出品的裝飾家具。',
  furniture_health_potion: '拆封後可在自己的領地放置高級治療藥水裝飾品。ORKEA 出品的裝飾家具。',
  furniture_healing_potion: '拆封後可在自己的領地放置治療藥水裝飾品。ORKEA 出品的裝飾家具。',
  furniture_scroll: '拆封後可在自己的領地放置捲軸裝飾品。ORKEA 出品的裝飾家具。',
  furniture_scroll_enchant: '拆封後可在自己的領地放置武器強化捲軸裝飾品。ORKEA 出品的裝飾家具。',
  furniture_scroll_enchant_armor: '拆封後可在自己的領地放置防具強化捲軸裝飾品。ORKEA 出品的裝飾家具。',
  furniture_iron_sword: '拆封後可在自己的領地放置鐵劍裝飾品。ORKEA 出品的裝飾家具。',
